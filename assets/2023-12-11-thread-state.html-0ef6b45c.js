import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as n,f as d}from"./app-49c973d3.js";const l={},s=d(`<h2 id="thread状态" tabindex="-1"><a class="header-anchor" href="#thread状态" aria-hidden="true">#</a> Thread状态</h2><p>Java的线程状态总共有六种，在Thread类的枚举类State中，总共有6种状态，代码如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>  public enum State {
        NEW,
        RUNNABLE,
        BLOCKED,
        WAITING,    
