import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,f as e}from"./app-706af41e.js";const i={},l=e(`<h2 id="final关键字的基本用法" tabindex="-1"><a class="header-anchor" href="#final关键字的基本用法" aria-hidden="true">#</a> final关键字的基本用法</h2><p>final关键字，用于表示不可变，表示变量或者方法定义后不能被修改或者重写。final关键字可以用于修饰类、方法和变量。</p><ol><li>修饰类：当类被声明为final时，表明该类不能被继承。它是一个最终类，不能有子类继承它。</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public final class FinalTest {
}
