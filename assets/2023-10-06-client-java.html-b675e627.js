...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://static.javajike.com/img/2023/10/21/image-20231021115611700.png" alt="image-20231021115611700" tabindex="0" loading="lazy"><figcaption>image-20231021115611700</figcaption></figure>`,12);function m(p,b){const i=r("ExternalLinkIcon");return l(),u("div",null,[a,e("p",null,[t("然后在浏览器上访问"),e("a",c,[t("http://localhost:9400/metrics，可以看到有两个指标http_count_total和http_count_seconds，指标数据如下："),o(i)])]),v])}const h=s(d,[["render",m],["__file","2023-10-06-client-java.html.vue"]]);export{h as default};
