import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as n,f as d}from"./app-c1521a7f.js";const l={},a=d(`<h2 id="thread状态" tabindex="-1"><a class="header-anchor" href="#thread状态" aria-hidden="true">#</a> Thread状态</h2><p>Java的线程状态总共有六种，在Thread类的枚举类State中，总共有6种状态，代码如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>  public enum State {
        NEW,
        RUNNABLE,
        BLOCKED,
        WAITING,    
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>创建了两个线程<code>t1</code>和<code>t2</code>，它们通过共享的锁对象<code>lock</code>来实现交替打印奇数和偶数。</p><p>具体来说，每个线程执行如下操作：</p><ol><li>进入一个无限循环，在循环内部使用<code>synchronized (lock)</code>来获取对共享锁对象<code>lock</code>的独占锁定。</li><li>判断当前的计数<code>i</code>是偶数还是奇数，根据结果决定是否等待或执行打印操作，并将<code>i</code>的值递增。</li><li>在打印完成后，调用<code>lock.notifyAll()</code>来唤醒其他因等待相同锁而处于暂停状态的线程，并释放锁。</li><li>然后线程继续循环执行以上步骤。</li></ol><p>这是考察线程同步的例子，通过共享锁对象的<code>wait()</code>与<code>notifyAll()</code>方法来协调两个线程的执行顺序。从而达到交替打印奇偶输的目的。</p><figure><img src="https://static-1254191423.cos.ap-shanghai.myqcloud.com/img/common/wxcode.png" alt="方志朋_官方公众号" tabindex="0" loading="lazy"><figcaption>方志朋_官方公众号</figcaption></figure>`,40),s=[a];function r(t,c){return i(),n("div",null,s)}const b=e(l,[["render",r],["__file","2023-12-11-thread-state.html.vue"]]);export{b as default};
