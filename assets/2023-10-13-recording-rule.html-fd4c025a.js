...
- name: recording_rule
  ...
  - record: instance_handler_code:prometheus_http_requests:rate1m
   ...
   - ./first_rule.yml
   - ./recoding_rule.yml
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>重新启动Prometheus，在Prometheus的页面上可以查看新指标的数据，如下：</p><figure><img src="https://static.javajike.com/img/2023/10/29/image-20231023210926364.png" alt="image-20231023210926364" tabindex="0" loading="lazy"><figcaption>image-20231023210926364</figcaption></figure>`,31),s=[l];function t(d,u){return i(),n("div",null,s)}const m=e(a,[["render",t],["__file","2023-10-13-recording-rule.html.vue"]]);export{m as default};
