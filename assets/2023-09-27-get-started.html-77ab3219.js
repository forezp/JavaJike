import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{r,o,c as l,a as e,b as a,d as t,f as i}from"./app-f5ed9bbc.js";const d={},c=e("p",null,"本文是Prometheus环境的搭建和安装，包括prometheus-sever、node-exporter、grafna的安装。安装成功后，配置prometheus采集node-exporter的指标，然后在grafana展示node-exporter采集的指标。",-1),u=e("h2",{id:"安装prometheus",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#安装prometheus","aria-hidden":"true"},"#"),a(" 安装prometheus")],-1),m={href:"https://prometheus.io/download/",target:"_blank",rel:"noopener noreferrer"},g=i(`<figure><img src="https://static.javajike.com/img/2023/10/8/image-20231008083006727.png" alt="image-20231008083006727" tabindex="0" loading="lazy"><figcaption>image-20231008083006727</figcaption></figure><p>下载完成后，执行解压：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>tar -zxvf prometheus-2.47.1.darwin-amd64.tar.gz 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,4),B={href:"http://localhost:9100/metrics%EF%BC%8C%E5%B0%B1%E5%8F%AF%E4%BB%A5%E6%9F%A5%E7%9C%8Bnode_exporter%E6%9A%B4%E9%9C%B2%E7%9A%84%E7%AB%AF%E5%8F%A3%E6%8C%87%E6%A0%87%E3%80%82",target:"_blank",rel:"noopener noreferrer"},A=i(`<p>在prometheus的配置文prometheus.yml中，增加采集Node Exporter的任务，配置信息如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>scrape_configs:
  - job_name: &quot;prometheus&quot;
    static_configs:
      - targets: [&quot;localhost:9090&quot;]
